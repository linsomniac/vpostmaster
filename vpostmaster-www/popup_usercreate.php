...
<?php if (strstr($_SERVER["REQUEST_URI"], "create.php") == FALSE) { ?>
   <h1>vPostMaster Create Mail User Documentation</h1>
<?php } else { ?>
   <h1>vPostMaster Create Mail User Documentation</h1>
<?php } ?>

<a name='name'><h2>Mail User Name</h2>
<p />The mail user name.
<p />This should be a simple user name, the part to the left of the "@"
symbol in the e-mail address (user@example.com).  It should only consist of lowercase letters and numbers and the "." (dot) and "_" (underscore) characters.
<p />It should <strong>not</strong> contain the domain extension character
(-&nbsp;or&nbsp;+)  <strong>Not</strong>: user-badname@example.com or user+badname@example.com 
